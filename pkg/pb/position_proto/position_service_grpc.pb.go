...
const (
	PositionService_SavePosition_FullMethodName = "/target.position.PositionService/SavePosition"
)
...
func (c *positionServiceClient) SavePosition(ctx context.Context, in *SavePositionRequest, opts ...grpc.CallOption) (*SavePositionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SavePositionResponse)
	err := c.cc.Invoke(ctx, PositionService_SavePosition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPositionServiceServer) SavePosition(context.Context, *SavePositionRequest) (*SavePositionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SavePosition not implemented")
}
...
func _PositionService_SavePosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SavePositionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PositionServiceServer).SavePosition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PositionService_SavePosition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PositionServiceServer).SavePosition(ctx, req.(*SavePositionRequest))
	}
...
var PositionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "target.position.PositionService",
	HandlerType: (*PositionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SavePosition",
			Handler:    _PositionService_SavePosition_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/position_service.proto",
}
